...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="container text-white position-relative">
          <div className="row align-items-center">
            <div className="col-lg-6 order-lg-1 order-2">
              ...
              >
                <div
                  className="image-overlay position-relative"
                  ...
                  <div className="card-enhanced p-4 h-100">
                    ...
                    <ul className="list-unstyled">
                      <li className="mb-3 d-flex align-items-start">
                        <span
                          className="bg-gradient-primary rounded-circle d-inline-flex align-items-center justify-content-center me-3"
                          style={{
                            width: "8px",
                            height: "8px",
                            marginTop: "8px",
                      ...
                      <li className="mb-3 d-flex align-items-start">
                        <span
                          className="bg-gradient-secondary rounded-circle d-inline-flex align-items-center justify-content-center me-3"
                          style={{
                            width: "8px",
                            height: "8px",
                            marginTop: "8px",
                      ...
                      <li className="mb-3 d-flex align-items-start">
                        <span
                          className="bg-gradient-tertiary rounded-circle d-inline-flex align-items-center justify-content-center me-3"
                          style={{
                            width: "8px",
                            height: "8px",
                            marginTop: "8px",
        ...
        <div className="container text-white">
          <div className="text-center mb-5">
            ...
            <p className="fs-5 text-muted">
              Ready to start your next project? Lets discuss your ideas!
            </p>
          </div>
      ...
      >
        <p className="mb-0">
          &copy; {new Date().getFullYear()} Overbed Studio. All rights reserved.
        </p>
      </footer>
    </>
  );
